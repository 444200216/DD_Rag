  ...
  <div class="p-6 flex flex-col h-full">
    ...
    <div class="mb-6 flex items-center gap-3">
      ...
      <ElInput
        ...
        class="flex-1"
      />
      <ElButton type="primary" size="large" @click="handleAsk" :loading="asking" :disabled="!groupStore.currentGroupId || !question.trim()">
        提问
      </ElButton>
    </div>

    <!-- Conversation Display (Bottom) -->
    <div class="flex-1 overflow-auto space-y-6">
      ...
      <div v-for="conv in conversations" :key="conv.id">
        ...
        <div class="flex justify-end mb-3">
          <div class="bg-blue-50 rounded-lg p-4 max-w-[70%]">
        ...
        <div v-if="conv.answer" class="flex justify-start mb-3">
          <div class="bg-gray-50 rounded-lg p-4 max-w-[70%]">
